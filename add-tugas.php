<?php
    ...
    $matkul = $table->find(array('id_kelas' => $kelas['id_kelas']));
?>
<!DOCTYPE html>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            <form method="post" class="form-horizontal" action="add-new-tugas.php">
                                <div class="card-body">
                                    <h4 class="card-title">Tugas Kuliah Baru</h4>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <select name="matkul" class="select2 form-select shadow-none"
                                    ...
                                    <div class="form-group row">
                                        <label for="fname"
                                            class="col-sm-3 text-end control-label col-form-label">Judul Tugas</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="judul" class="form-control" id="fname"
                                                placeholder="Masukkan judul tugas di sini">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname"
                                            class="col-sm-3 text-end control-label col-form-label">Dosen pengampu</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="dosen" class="form-control" id="fname"
                                                placeholder="Masukkan nama dosen pengampu di sini">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname"
                                            class="col-sm-3 text-end control-label col-form-label">Tanggal Deadline</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="deadline" class="form-control mydatepicker" placeholder="mm/dd/yyyy">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-3 text-end control-label col-form-label">Metode Pengerjaan</label>
                                        <div class="col-md-9">
                                            <select name="metode" class="select2 form-select shadow-none"
                                                style="width: 100%; height:36px;">
                                                <option>Pilih Metode</option>
                                                <option value="Individu">Individu</option>
                                                <option value="Kelompoik">Kelompok</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="cono1"
                                            class="col-sm-3 text-end control-label col-form-label">Deskripsi Tugas</label>
                                        <div class="col-sm-9">
