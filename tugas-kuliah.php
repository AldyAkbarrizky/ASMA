<?php
    ...
    $table2 = $database->MateriKuliah;
    $tugas = $table->findOne(array('kelas' => $_SESSION['Kelas']));
?>
<!DOCTYPE html>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
                    ...
                    <ul class="navbar-nav float-end">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end user-dd animated" aria-labelledby="navbarDropdown">
                                <i class="dropdown-item" style="font-style: normal;">
                                    <strong>
                                    <?php
                                        echo $_SESSION["Nama"];
                                    ?>
                                ...
                                <i class="dropdown-item" style="font-style: normal;">
                                    <?php
                                        echo $_SESSION["Role"]." ".$_SESSION["Kelas"];
                                    ?>
                                </i>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Daftar Tugas Kelas <?php echo $tugas["kelas"] ?></h4>
            ...
            <div class="container-fluid">
                ...
                <!-- Start Page Content -->
                <!-- ============================================================== -->
                <a href="add-tugas.php" class="btn btn-cyan btn-sm text-white" style="margin-bottom: 20px;">Tambah Tugas</a>
                <div class="row">
                    <?php
                        if(empty($tugas["tugas"])) {
                    ?>
                        <div style="margin-left: 1px">Mata Kuliah ini belum memiliki tugas apapun, mantab jiwa</div>
                    <?php
                        } else {
                            foreach($tugas["tugas"] as $item) {
                                $matakuliah = $table2->findOne([ '_id' => new MongoDB\BSON\ObjectID($item['id_matkul']) ])
                    ?>
                        <div class="col-md-8" style="margin: 0 auto">
                            <div class="card">
                                <div class="card-body">
                                    <a href="delete-tugas.php?id_tugas=<?php echo $item['id_tugas'] ?>&id_kelas=<?php echo $tugas['_id'] ?>"><button type="button" class="btn btn-danger" style="float:right; color: white">Hapus</button></a>
                                    <a href="edit-tugas.php?id_tugas=<?php echo $item['id_tugas'] ?>&id_kelas=<?php echo $tugas['_id'] ?>"><button type="button" class="btn btn-info" style="float:right; margin-right: 15px">Edit</button></a>
                                    <h3 class="card-title"><?php echo $item['nama_tugas'] ?></h3>
                                    <strong><div><?php echo $matakuliah['nama_matkul']?> - <?php echo $item['dosen_pengampu']?></div></strong>    
                                    <div>Ditambahkan : <?php echo $item['waktu_penugasan']->toDateTime()->format('l, d F Y') ?></div>
                                    <div>Deadline : <?php echo $item['waktu_deadline']->toDateTime()->format('l, d F Y') ?></div><br/>
                                    <p><?php echo $item['deskripsi_tugas'] ?></p>
                                </div>
                            </div>
                        </div>
                    <?php
