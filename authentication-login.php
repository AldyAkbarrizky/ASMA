        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark" style="height: 100vh">
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    ...
                    <!-- Form -->
                    <form method="post" class="form-horizontal mt-3" id="loginform" action="login.php">
                        <div class="row pb-4">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="NIM" class="form-control form-control-lg" placeholder="NIM" aria-label="NIM" aria-describedby="basic-addon1" required="">
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
