        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Form Pengisian Data Announcement</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            <form method="post" class="form-horizontal" action="add-new-announcement.php">
                                <div class="card-body">
                                    <h4 class="card-title">Announcement Baru</h4>
                                    <input type="hidden" name="id_mahasiswa" value="<?php echo $mhs['_id']; ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="judul" class="form-control" id="fname"
                                                placeholder="Masukkan judul pengumuman di sini">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="cono1"
