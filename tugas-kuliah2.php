            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Tugas Kuliah</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Daftar Mata Kuliah Kelas <?php echo $_SESSION["Kelas"]; ?> (Klik Mata Kuliah untuk melihat Daftar Tugas)</h5>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><a href="tugas.php?matkul=<?php echo $matkul['_id'] ?>"><?php echo $matkul['nama_matkul'];?></a></td>
